    ...
    <div className="w-1/2 flex flex-col justify-center items-center">
      <div className="w-[80%] mt-2">
        ...
        <select
          ...
          className="px-2 bg-indigo-200 py-3 rounded-sm text-base accent-blue-700 mt-1 w-full"
        >
      ...
      {!file && (
        <label
          htmlFor="upload"
          className="px-2 bg-indigo-200 py-3 rounded-sm text-base w-[80%] mt-4 flex justify-center items-center cursor-pointer"
        >
      ...
      <button
        className="bg-indigo-500 text-white mt-8 px-4 py-2 rounded-sm"
